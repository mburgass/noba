...
ggplot(new_intervals, aes(x =year, y = fit)) +
  ...
  xlab("Year") +
  ylab("PropPred") +
  ggtitle("Regressions of Proportion of Predators for three fishing scenarios; P= < 2.2e-16, R2 0.9545")
...
ggplot(new_intervals, aes(x =year, y = fit)) +
  ...
  xlab("Year") +
  ylab("Mean Life Span") +
  ggtitle("Regressions of Mean Life Span for three fishing scenarios; P= < 2.2e-16, R2 0.7016")
...
ggplot(new_intervals, aes(x =year, y = fit)) +
  ...
  ggtitle("Regressions of Inverse Fishing Pressure for three fishing scenarios; P= <2.2e-16, R2 0.6125")
...
ggplot(new_intervals, aes(x =year, y = fit)) +
  ...
  xlab("Year") +
  ylab("Inverse Pressure") +
  ggtitle("Regressions of Inverse Fishing Pressure (no capelin) for three fishing scenarios; P= <2.2e-16, R2 0.9996")
