read.csv("stats/lpi/adjusted/lpiscores_fmsy0_adjusted.csv")  -> lpi_fmsy0
read.csv("stats/lpi/adjusted/lpiscores_fmsy2_adjusted.csv") -> lpi_fmsy2
read.csv("stats/lpi/adjusted/lpiscores_fmsy1_adjusted.csv") -> lpi_fmsy1
