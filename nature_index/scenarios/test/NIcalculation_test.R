...
# Read input data
fmsy0_natureindex<- read.csv("nature_index/scenarios/test/fmsy0_natureindex_test.csv")
fmsy1_natureindex<- read.csv("nature_index/scenarios/test/fmsy1_natureindex_test.csv")
fmsy2_natureindex<- read.csv("nature_index/scenarios/test//fmsy2_natureindex_test.csv")
virgin_biomass_natureindex<- read.csv("nature_index/scenarios/test/virgin_biomass_natureindex_test.csv")
ni_indicators_noba<- read.csv("nature_index/scenarios/test/ni_indicators_noba_test.csv")
